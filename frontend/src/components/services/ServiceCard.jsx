...
export default function ServiceCard({ 
  ...
  return (
    <div 
      className={`bg-white p-4 md:p-5 rounded-xl shadow-sm transition-all duration-300 border border-gray-100 ${
    ...
    >
      ...
      <div className="flex items-start mb-3 md:mb-4">
        <div className="bg-red-50 p-2 md:p-3 rounded-xl mr-3 md:mr-4 flex-shrink-0">
          <img 
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-base md:text-lg font-bold text-gray-800 truncate">{service.name}</h3>
          <p className="text-gray-600 text-xs md:text-sm mt-1 line-clamp-2">{service.description}</p>
        </div>
      </div>
      ...
      <div className="mt-3 md:mt-4">
        ...
        {user ? (
          <button
            ...
            className={`w-full flex items-center justify-center py-2 md:py-3 px-3 md:px-4 rounded-xl text-white font-medium ${
            ...
            } transition-all shadow-sm active:shadow-inner text-sm md:text-base`}
          >
          ...
          <button 
            ...
            className="w-full py-2 md:py-3 px-3 md:px-4 rounded-xl text-white bg-gradient-to-br from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 active:from-red-700 active:to-red-800 transition-all flex items-center justify-center font-medium shadow-sm active:shadow-inner text-sm md:text-base"
          >
